...
function App() {
  ...
  const handleSelectedAnswers = (id, e) => {
    ...
    if (newSelectedAnswers.includes(id)) {
      newSelectedAnswers = newSelectedAnswers.filter((item) => item !== id);
    } else {
  ...
  return (
    <div className="App container-fluid">
      <header className="App-header">
        <h1>
          Sir Vote-a-lot - <small>enjoy!</small>
        </h1>
      </header>
      <div className="row">
              ...
              {answers.map((answer) => {
                return (
                  <div key={answer.id} className="form-check">
                    ...
                    />
                    <label
                      className="form-check-label d-block text-wrap"
